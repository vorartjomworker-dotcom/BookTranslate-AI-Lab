...
export default function HomePage() {
  const { user, status: authStatus, sessionExpired, logout, dismissSessionExpired } = useAuth();
  ...
  useEffect(() => { if (authStatus === 'authenticated') { void loadBooks(); void loadRuns(); } }, [authStatus]);
